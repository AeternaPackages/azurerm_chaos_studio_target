...
module "chaos_studio_targets" {
  source               = "git::https://github.com/AeternaModules/azurerm_chaos_studio_target.git?ref=v5.0.1"
  chaos_studio_targets = local.chaos_studio_targets
}

module "chaos_studio_capabilities" {
  source                    = "git::https://github.com/AeternaModules/azurerm_chaos_studio_capability.git?ref=v5.0.1"
